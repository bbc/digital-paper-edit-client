...
![Firebase architectural diagram](./DPE - firebase ver.png)
...
- Authentication is provided without requirement of much setup
...
Arbitrary number of days that it will take (rough estimate)
